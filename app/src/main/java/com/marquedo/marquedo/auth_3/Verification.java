...
import static com.marquedo.marquedo.helpers.InternetCheck.getConnectionType;
import static com.marquedo.marquedo.helpers.InternetCheck.getConnectivityStatusString;
import static com.marquedo.marquedo.helpers.OurConstants.OTP_FCMID_KEY;
import static com.marquedo.marquedo.helpers.OurConstants.OTP_PHONE_KEY;
import static com.marquedo.marquedo.helpers.OurConstants.OTP_PREFERENCES;
import static com.marquedo.marquedo.helpers.OurConstants.OTP_SHOPNAME_KEY;
import static com.marquedo.marquedo.helpers.OurConstants.SHOW_TIME;
import static com.marquedo.marquedo.helpers.OurConstants.TYPE_NOT_CONNECTED;
...
import com.marquedo.marquedo.helpers.InternetCheck;
import com.marquedo.marquedo.helpers.OurConstants;
...
public class Verification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.auth_3_activity_verification);
        initializations();
        operations();
        buttononclicksthis();
    }
...
// Configure faking the auto-retrieval with the whitelisted numbers.
        ...
        PhoneAuthOptions options = PhoneAuthOptions.newBuilder(firebaseAuth)
                ...
                .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationCompleted(@NonNull final PhoneAuthCredential credential) {
                        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(Verification.this, task -> {
                            if (task.isSuccessful()) {
                                ...
                                if (flagOP < 3) {
                                    ...
                                    new Handler(Looper.getMainLooper()).postDelayed(() -> {
                                        Intent intent = new Intent(Verification.this, MobileNumber.class);
                                ...
                                check.set(shopOwner)
                                    .addOnSuccessListener(aVoid -> {
                                        ...
                                        if (shopName == null) {
                                            ...
                                            startActivity(new Intent(this, BusinessDetail.class)
                                        ...
                                        if (shopName == null) {
                                            ...
                                            check.update(exists).addOnCompleteListener(task1 -> {
                                                if (task1.isSuccessful()) {
                                                    ...
                                                    /* To Fix the bug String shopCategory = doc.getString(OTP_SHOPCATEGORY_KEY);
    ...
    private CustomCountDownTimer createCountDownTimer(final TextView timerText, final Verification fragment) {
        return new CustomCountDownTimer(RESEND_WAIT_MILLIS, 500) {
            final Verification mSubmitConfirmationCodeFragment = fragment;
