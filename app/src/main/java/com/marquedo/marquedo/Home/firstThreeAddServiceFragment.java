...
public class firstThreeAddServiceFragment extends Fragment implements CheckboxData
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        addNServices = v.findViewById(R.id.add_3_services);
...
//        setInitialData();
        ...
        MaterialButton signup= v.findViewById(R.id.prod_continue_button);


        bottomSheetDialog = new BottomSheetDialog(v.getContext(), R.style.CustomAlertDialog);
        bottomSheetDialog.setContentView(R.layout.home_fragment_new_services_category);
...
//        });
    ...
    private void getInitialData() {
        ...
        SharedPreferences sharedPreferences = getContext().getSharedPreferences(OTP_PREFERENCES, MODE_PRIVATE);
