package com.marquedo.marquedo.ui.Orders_Enquiries;
...
public class Orders_n_Enquiry extends Fragment {
    ...
    public static Orders_n_Enquiry newInstance() {
        return new Orders_n_Enquiry();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_order_enquiry_page, container, false);
