package com.marquedo.marquedo.ui.ui_3_Orders_Enquiries.Orders;
...
import com.marquedo.marquedo.ui_3_orders_enquiries.OrderDetailsOverview;
...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.ViewHolder> {
    ...
    public OrderListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OrderListAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.ui_ui_3_orderspage_order_tile, null));
    }
    ...
    public void onBindViewHolder(@NonNull OrderListAdapter.ViewHolder holder, int position) {
        ...
        holder.vieworderdetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), OrderDetailsOverview.class);
