...
import com.marquedo.marquedo.ui_2_Prod_n_Cat.UpdateProduct;
...
public class ProductsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.ui_ui_2_fragment_products, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ProductListAdapter(data,
                item -> startActivity(new Intent(getContext(), UpdateProduct.class))));
