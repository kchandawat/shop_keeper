...
public class OurConstants {
    ...
    public static final String PHONE_NUMBER_LOGIN = "PhoneNumber";
    public static final String OTP_PHONE_KEY = "ContactNumber";
    public static final String OTP_UID_KEY = "Uid";
