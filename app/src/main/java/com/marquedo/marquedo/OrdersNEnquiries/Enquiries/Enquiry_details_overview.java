...
public class Enquiry_details_overview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ordersnenquiries_enquiries_activity_enquiry_details);
        Button RejectButton = findViewById(R.id.btnRejectEnquiry);
...
//        Delivery_Category deliveryCategory = new Delivery_Category(this, this);
        ...
        MaterialButton editOrder = findViewById(R.id.btneditEnquiry);
        ...
        RejectButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View view2 = getLayoutInflater().inflate(R.layout.ordersnenquiries_order_reject_confirmation, null);
...
//                });
        ...
        editOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditEnquiryBottomSheet editEnquiryBottomSheet = new EditEnquiryBottomSheet();
                editEnquiryBottomSheet.show(getSupportFragmentManager(), "TAG");
            }
        });
        ...
        deliveryMode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                View view2 = getLayoutInflater().inflate(R.layout.ordersnenquiries_delivery_mode_bottomsheet, null);
        ...
        RecyclerView rvOrders = (RecyclerView) findViewById(R.id.rvEnquiriesRecyclerList);
    ...
    public class RecyclerAdapter extends
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View ordersView = inflater.inflate(R.layout.ordersnenquiries_details_tile, parent, false);
