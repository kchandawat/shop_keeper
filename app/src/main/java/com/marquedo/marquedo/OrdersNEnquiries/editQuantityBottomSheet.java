...
public class editQuantityBottomSheet extends BottomSheetDialogFragment {
    ...
    public editQuantityBottomSheet(String quantity, Orders_details_overview_model model){
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        View view = LayoutInflater.from(getContext()).inflate(R.layout.ordersnenquiries_edit_quantity, null);
