...
import com.marquedo.marquedo.OrdersNEnquiries.editQuantityBottomSheet;
...
public class EditOrderBottomSheet extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        View view = LayoutInflater.from(getContext()).inflate(R.layout.ordersnenquiries_orders_edit_order_bottomsheet, null);
        ...
        bottomSheetDialog.setContentView(R.layout.ordersnenquiries_orders_activity_order_details);
        ...
        RecyclerView rvOrders = (RecyclerView) view.findViewById(R.id.OrderRecyclerList);
    ...
    public class RecyclerAdapter extends
        ...
        public  class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                ...
                tveditQuantity = (TextView) itemView.findViewById(R.id.editQuantity);
            }
        }
        ...
        public RecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View ordersView = inflater.inflate(R.layout.ordersnenquiries_orders_edit_order_tile, parent, false);
