...
public class EditEnquiryBottomSheet extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        //Set the custom view
        View view = LayoutInflater.from(getContext()).inflate(R.layout.ordersnenquiries_enquiries_edit_enquiry_bottomsheet, null);
        ...
        bottomSheetDialog.setContentView(R.layout.ordersnenquiries_enquiries_activity_enquiry_details);
