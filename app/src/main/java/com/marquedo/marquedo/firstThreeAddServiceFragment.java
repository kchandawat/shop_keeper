 ...
 * Use the {@link firstThreeAddServiceFragment#newInstance} factory method to
...
public class firstThreeAddServiceFragment extends Fragment {
     ...
     * @return A new instance of fragment firstThreeAddServiceFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        continuebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(view.getContext(), profileSetupAddServicePageActivity.class));
            }
        });
        return v;
