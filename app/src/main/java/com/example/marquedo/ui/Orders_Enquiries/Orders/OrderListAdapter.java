...
import com.example.marquedo.Order_details_overview;
import com.example.marquedo.R;
import com.example.marquedo.otp;
...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.ViewHolder> {
    ...
    public OrderListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OrderListAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.orderspage_order_tile, null));
    }
